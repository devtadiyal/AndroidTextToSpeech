...
public class VoiceRecognitionTest extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button speakButton = findViewById(R.id.btn_speakVoice);
        Button stopButton = findViewById(R.id.btn_stopVoice);
        mTextTimer = findViewById(R.id.textViewTimer);
        mText = findViewById(R.id.textView1);
        mTextCaptured = findViewById(R.id.et_from);
        imagePlay = findViewById(R.id.img_play);
        imagePause = findViewById(R.id.img_pause);
        imageStop = findViewById(R.id.img_stop);
    ...
    private void requestPermission() {
        ...
        ActivityCompat.requestPermissions(VoiceRecognitionTest.this, new String[]{WRITE_EXTERNAL_STORAGE, RECORD_AUDIO}, RequestPermissionCode);
            ...
            case RequestPermissionCode:
                if (grantResults.length > 0) {
                    ...
                    if (StoragePermission && RecordPermission) {
                        ...
                        recognizer.setRecognitionListener(new listener());
                        timerStart(61000);
                        Toast.makeText(VoiceRecognitionTest.this, "Permission Granted", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(VoiceRecognitionTest.this, "Permission Denied", Toast.LENGTH_LONG).show();
